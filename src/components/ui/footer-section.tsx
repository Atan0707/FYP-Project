      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              <a href="#header" className="block transition-colors hover:text-primary">
                Home
              </a>
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic">
              ...
              <p>Cawangan Melaka Kampus Jasin,</p>
              <p>77300 Merlimau,</p>
              <p>Melaka Malaysia,</p>
            </address>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 text-center md:flex-row">
          <p className="text-sm text-muted-foreground">
            © 2025 WEMSP. Created by <a href="https://next-portfolio-khaki-beta.vercel.app/" className="text-primary">Hariz Hakim</a>.
          </p>
